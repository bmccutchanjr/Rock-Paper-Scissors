...
// 05 var PlayerOne = {};
// 05 var PlayerTwo = {};
// 05 var iAmPlayerOne = false;
var Player = [];
var iAmPlayerNumber = -1;
...
// 05 function whichPlayer()
// 05 {   // simply returns the string "playerOne" or "playerTwo" depending on the value of iAmPlayerOne
// 05 
// 05     if (iAmPlayerOne) return "PlayerOne";
// 05 
// 05     return "PlayerTwo";
// 05 }
...
{   // How many players are already connected to the game
    ...
    var number = 0;
// 05     if (PlayerOne.Name) ++number;
// 05     if (PlayerTwo.Name) ++number;
console.log(Player[0]);
console.log(Player[1]);
    if (Player[0] && Player[0].Name) ++number;
    if (Player[1] && Player[1].Name) ++number;
...
// 05 console.log("PlayerTwo: ", PlayerTwo);
...
// 05             if (iAmPlayerOne)
            if (iAmPlayerNumber === 0)
// 05             {   playerOneName = tName;
            {   Player[0].Name = tName;
...
// 05                 if (PlayerTwo.Name)
// 05                 {   setMessage (database, PlayerOne.Name + " challenges " + PlayerTwo.Name)
                if (Player[1].Name)
                {   setMessage (database, Player[0].Name + " challenges " + Player[1].Name)
                }
            }
            else
// 05             {   playerTwoName = tName;
            {   Player[1].Name = tName;

                setName (database, "PlayerTwo", tName);

// 05                 if (PlayerOne.Name)
// 05                 {   setMessage (database, PlayerTwo.Name + " challenges " + PlayerOne.Name)
                if (Player[0].Name)
                {   setMessage (database, Player[1].Name + " challenges " + Player[0].Name)
                }
            }

            // and hide the #name-input form, we don't use it again
            $("name-form").css("display", "none");
        }
    })
...
// 05             PlayerOne = snap.val();
            ...
            {   // only do this if both player1 and player2 have connected
                ...
                var pTag = $("<p>");
// 05                pTag.html("<b>" + PlayerOne.Name + "</b> vs. <b>" + PlayerTwo.Name + "</b>");
                pTag.html("<b>" + Player[0].Name + "</b> vs. <b>" + Player[1].Name + "</b>");
                nameDiv.append(pTag);
